...
exports.parseAdtError = parseAdtError;
exports.formatError = formatError;
exports.formatActivationMessages = formatActivationMessages;
function parseAdtError(error) {
    ...
    let rawMessage = ((_b = (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) ||
        ((_d = (_c = error === null || error === void 0 ? void 0 : error.response) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d['message']) ||
        (typeof ((_e = error === null || error === void 0 ? void 0 : error.response) === null || _e === void 0 ? void 0 : _e.data) === 'string' ? error.response.data : '') ||
        (typeof ((_f = error === null || error === void 0 ? void 0 : error.response) === null || _f === void 0 ? void 0 : _f.body) === 'string' ? error.response.body : '') ||
    ...
    const localized = (error === null || error === void 0 ? void 0 : error.localizedMessage) || '';
    const propsBag = (error === null || error === void 0 ? void 0 : error.properties) || {};
    const propStr = Object.keys(propsBag).length
    ...
    if (rawMessage.includes('This syntax cannot be used for an object name') ||
    ...
    let status = (_h = (_g = error === null || error === void 0 ? void 0 : error.response) === null || _g === void 0 ? void 0 : _g.status) !== null && _h !== void 0 ? _h : (typeof (error === null || error === void 0 ? void 0 : error.err) === 'number' ? error.err : undefined);
    if (status === undefined) {
    ...
    const isAmbiguous400 = status === 400 &&
    ...
    return {
        message: rawMessage,
        isSessionTimeout: msg.includes('session timed out') ||
            msg.includes('session not found') ||
            msg.includes('not logged on') ||
            status === 401 ||
            isAmbiguous400,
        isUpgradeMode: msg.includes('adjustment mode') ||
...
function formatError(operation, error) {
    ...
    if (info.isUpgradeMode) {
        return (`${operation} failed: object is in SPAU adjustment mode (upgradeFlag=true). ` +
    ...
    if (info.isAmbiguous400) {
        return (`${operation} failed: HTTP 400 with no error detail. withSession already re-logged in and ` +
    ...
    if (info.isLockNotSupported) {
        return (`${operation} failed: HTTP 405 — this object type does not support ADT HTTP locks. ` +
    ...
    if (info.isLocked) {
        return (`${operation} failed: object is locked by another user or session. ` +
 ...
 */
function formatActivationMessages(messages) {
    if (!messages || messages.length === 0)
        return 'Activation failed — no error messages returned.';
