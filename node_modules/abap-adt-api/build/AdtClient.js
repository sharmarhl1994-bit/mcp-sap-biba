...
class ADTClient {
    ...
    setDomainProperties(domainUrl, properties, metaData, lockHandle, transport) {
        return (0, api_1.setDomainProperties)(this.h, domainUrl, properties, metaData, lockHandle, transport);
    }
    setDataElementProperties(dataElementUrl, properties, metaData, lockHandle, transport) {
        return (0, api_1.setDataElementProperties)(this.h, dataElementUrl, properties, metaData, lockHandle, transport);
    }
    /**
    ...
    atcDocumentation(docUri) {
        return (0, api_1.atcDocumentation)(this.h, docUri);
    }
